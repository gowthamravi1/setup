...
java -jar -Dindex.name=cms-all -Dnodes=localhost:9300 -Damq.pass=amqpass -Dcluster.name=prana -DKLOOPZ_AMQ_HOST=localhost -Dsearch.maxConsumers=10 $OO_HOME/dist/prana/dist/search.jar
